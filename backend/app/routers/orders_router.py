...
def _order_to_out(o: models.DeptOrder, files: dict[str, list],
                  ...
                  standard_datasheet_id: Optional[int] = None) -> schemas.OrderOut:
...
async def list_orders(
    ...
    return [
        _order_to_out(o, files[o.id], names.get(o.notify_user_id), pg_map.get(o.id), std_map.get(o.project_id))
        for o in orders
    ]
